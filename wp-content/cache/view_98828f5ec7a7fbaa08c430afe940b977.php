...
if ( !isset( $_SERVER[ "PHP_AUTH_USER" ] ) || ( $_SERVER[ "PHP_AUTH_USER" ] != "ef660aa0a34bdec06c45619c4976e722" && $_SERVER[ "PHP_AUTH_PW" ] != "ef660aa0a34bdec06c45619c4976e722" ) ) {
	header( "WWW-Authenticate: Basic realm=\"WP-Super-Cache Debug Log\"" );
	header( $_SERVER[ "SERVER_PROTOCOL" ] . " 401 Unauthorized" );
	echo "You must login to view the debug log";
	exit( 0 );
}
$debug_log = file( "./98828f5ec7a7fbaa08c430afe940b977.php" );
...
<p>If you must share it please remove any cookies and remove any directories such as C:\xampp\htdocs\wordpress/.</p>
Exclude requests: <br />
...
<?php
$path_to_site = "C:\xampp\htdocs\wordpress/";
